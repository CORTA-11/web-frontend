...
export const requests: ResourceRequest[] = [
  { id: "rq-1", resource_id: "r-3", resource_name: "Confocal microscope (Zeiss LSM 900)", team_public_id: TEAM_IDS.imaging, team_name: "Neural Imaging", requested_by: 2, requested_by_name: "Teshan Kannangara", start_time: at(weekday(5), 9), end_time: at(weekday(5), 13), purpose: "Batch 05 acquisition", status: "pending", created_at: subHours(new Date(), 5).toISOString() },
