    ...
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card
          ...
          description="A summary of the recent operations on the platform."
        >
          <div className="space-y-4 mt-2">
            {[
              { text: "Server deployment succeeded", time: "2 mins ago", type: "success" },
              { text: "Backup created successfully", time: "1 hour ago", type: "info" },
              { text: "Database connection spike detected", time: "3 hours ago", type: "warning" },
            ].map((activity, idx) => (
              <div
                key={idx}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm font-medium text-zinc-800 dark:text-zinc-250">
                    {activity.text}
                  </span>
                </div>
